                   ...
                   <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                     ...
                     <tbody>
                       ...
                       <tr>
                         ...
                         <td>
                           <a href="view.php?IDD_Prod=<?php echo htmlspecialchars($donnes['id_produit']); ?>">
                           <img class="img-thumbnail hh" src="imagesProd/<?php if(empty($donnes['image'])){echo "image.png";}else{ echo htmlspecialchars($donnes['image']);} ?>" alt="">
                           </a>
                         </td>
